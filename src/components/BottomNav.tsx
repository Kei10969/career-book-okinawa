  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 z-50 shadow-lg">
      <div className="max-w-lg mx-auto h-16 relative flex items-stretch">
        ...
        {/* ホーム */}
        <Link href="/" className="flex-1 flex flex-col items-center justify-center gap-0.5 text-blue-600">
        ...
        {/* 募集（左半分） */}
        <Link href="/requests" className="flex-1 flex flex-col items-center justify-center gap-0.5 text-gray-400">
        ...
        {/* 通知 */}
        <Link href="/notifications" className="flex-1 flex flex-col items-center justify-center gap-0.5 text-gray-400">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {/* マイページ */}
        <Link href="/mypage" className="flex-1 flex flex-col items-center justify-center gap-0.5 text-gray-400">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
