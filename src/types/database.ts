...
export type Trade =
  ...
  | '解体工事' | '型枠解体' | '内部解体' | '土木作業' | 'クレーン' | '重機オペ' | 'その他'

export type OkinawaCity =
  | '那覇市' | '糸満市' | '豊見城市' | '南城市' | '与那原町' | '南風原町' | '八重瀬町'
  | '浦添市' | '宜野湾市' | '沖縄市' | 'うるま市' | '読谷村' | '嘉手納町' | '北谷町' | '北中城村' | '中城村' | '西原町'
  | '名護市' | '国頭村' | '大宜味村' | '東村' | '今帰仁村' | '本部町' | '恩納村' | '宜野座村' | '金武町' | '伊江村'
  | '宮古島市' | '多良間村'
  | '石垣市' | '竹富町' | '与那国町'
  | '久米島町' | '渡嘉敷村' | '座間味村' | '粟国村' | '渡名喜村' | '伊平屋村' | '伊是名村' | '南大東村' | '北大東村'
